...
import Digits from '../../assets/images/car-removebg-preview.png';
                ...
                <ul className={`${classes.ul} ${classes.row} ${classes.spaceBetween} ${classes.psides}`}>
                    <Suspense fallback = {'loading...'}>
                        <AuthCheck fallback={
                            ...
                            <li>
                                <Button>
                                <Link to='/Cardirectory' className={`${classes.navbarItem} ${classes.psides}`}>My Car Directory</Link>
                                </Button>
                            </li>
                            <li>
                                <Button>
                                <Link to='/Home' className={`${classes.navbarItem} ${classes.psides}`}>Sign Out</Link>
                                </Button>
                            </li>
                        </AuthCheck>
                    </Suspense>
